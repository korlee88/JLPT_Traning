...
- **Where the list stands:** p.17 (あ행) is complete — items 1–20 (`青い` … `以上`) went in 2026-09-14 as batch 1 (#10), items 21–39 (`急ぐ` … `送る`) on 2026-09-15 as batch 2. The next photo should be a new page (か행 onward).
